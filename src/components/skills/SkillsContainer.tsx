...
const SkillsContainer: React.FC<SkillsProps> = ({t, lng}) => {
    ...
    return (
        <div className='row col-12 col-lg-9 skills__container'>
            ...
            <SkillCard languageName='Django REST' languageLevel={t('good')} languageIconPath='/img/logo-drf.png' lng={lng} />
            ...
            <SkillCard languageName='PHP' languageLevel={t('intermediate')} languageIconPath='/img/logo-php.png' lng={lng} />
        </div>
    )
}
